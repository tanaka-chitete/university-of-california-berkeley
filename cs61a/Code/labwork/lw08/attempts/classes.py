...
class TACard(Card):
    ...
    def effect(self, other_card, player, opponent):
        ...
        300
        """
        other_card_copy = other_card.copy()
        other_card.attack = other_card_copy.defense
        other_card.defense = other_card_copy.attack
...
class ProfessorCard(Card):
    ...
    def effect(self, other_card, player, opponent):
        ...
        # Adds attack and defense to all cards in player's deck
        new_cards = []
        ...
        # Removes all cards in opponent's deck that have the same attack or defense as opponent's card
        remaining_cards = []
        ...
        opponent.deck = Deck(remaining_cards)
